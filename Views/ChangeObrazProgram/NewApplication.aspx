...
<script type="text/javascript">
    ...
    function GetFaculties() {
        ...
        $('#Specs').hide();
        $('#Facs').show();
        $.post('/ChangeObrazProgram/GetFacs', { studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(), entry: $('#Entry').val() }, function (json_data) {
            var options = '';
    ...
    function GetProfessions() {
        ...
        $.post('/ChangeObrazProgram/GetProfs', { studyform: sfId, studybasis: $('#StudyBasisId').val(), 
    ...
    function GetSpecializations() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/ChangeObrazProgram/GetSpecializations', { prof: $('#lProfession').val(), obrazprogram: $('#lObrazProgram').val(), studyform: $('#StudyFormId').val(), 
...
<% using (Html.BeginForm("NewApp", "ChangeObrazProgram", FormMethod.Post))
   { 
%> 
