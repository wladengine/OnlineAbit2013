...
<script type="text/javascript">
    ...
    function GetFaculties() {
        ...
        $('#Specs').hide();
        $('#Facs').show();
        $.post('/TransferForeign/GetFacs', { studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(), entry: $('#Entry').val() }, function (json_data) {
            var options = '';
    ...
    function GetProfessions() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/TransferForeign/GetProfs', { studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(),
    ...
    function GetObrazPrograms() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/TransferForeign/GetObrazPrograms', { prof: $('#lProfession').val(), studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(), 
    ...
    function GetSpecializations() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/TransferForeign/GetSpecializations', { prof: $('#lProfession').val(), obrazprogram: $('#lObrazProgram').val(), studyform: $('#StudyFormId').val(), 
...
<% using (Html.BeginForm("NewApp", "TransferForeign", FormMethod.Post))
   { 
%> 
    ...
    <% if (Model.EntryType != 1)
       { %>
        ...
        <select id="Entry" name="Entry" onchange="ChangeEType()">
            ...
            <option value="3">Бакалавриат/Специалитет</option>
        </select>
    <% }
       else
       { %>
