...
%>
    ...
    <div class="grid">
        <div class="wrapper">
            ...
            <div class="grid_2">
                    <ol>
                        <li><a href="../../Abiturient?step=1">Личные данные</a></li>
                        <li><a href="../../Abiturient?step=2">Паспорт</a></li>
                        <li><a href="../../Abiturient?step=3">Контактная информация</a></li>
                        <li><a href="../../Abiturient?step=4">Образование</a></li>
                        <li><a href="../../Abiturient?step=5">Опыт работы</a></li>
                        <li><a href="../../Abiturient?step=6">Дополнительные сведения</a></li>
                    </ol>
                </div>
        </div>
    </div>
                ...
                <div class="grid_4 first">
                    ...
                    <form id="form" class="form panel" action="Abiturient/NextStep" method="post" onsubmit="return CheckForm();">
                        ...
                        <div id="HEData">
                            ...
                            <hr />
                            <div class="clearfix">
                                <%= Html.LabelFor(x => x.EducationInfo.PersonSpecialization, GetGlobalResourceObject("EducationInfo", "PersonSpecialization").ToString())%>
                                <%= Html.TextBoxFor(x => x.EducationInfo.PersonSpecialization)%>
                            </div>
                            <div class="clearfix">
                        ...
                        <div id="EGEData" class="clearfix">
                            ...
                            <%
                               ...
                               {
                            %>
                            <table id="tblEGEData" class="paginate" width="100%">
                                <thead>
                                <tr>
