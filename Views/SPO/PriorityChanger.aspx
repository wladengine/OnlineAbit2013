<%@ Page Title="" Language="C#" MasterPageFile="~/Views/SPO/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.MotivateMailModel>" %>
...
<form action="/Abiturient/ChangePriority" method="post">
    ...
    <button id="btnSave" type="submit" class="button button-green">Сохранить</button>
    <br />
</form>
