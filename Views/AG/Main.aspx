<%@ Page Title="" Language="C#" MasterPageFile="~/Views/AG/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.SimplePerson>" %>
   ...
   { %>
    <div id="<%= msg.Id %>" class="message info" style="padding:5px">
        ...
        <div style="float:right;">
            <span class="link" onclick="DeleteMsg('<%= msg.Id %>')">
    ...
    <% foreach (OnlineAbit2013.Models.SimpleApplication app in Model.Applications.Where(x => x.Enabled == true).OrderBy(x => x.Priority).ToList())
        { %>
         <tr>
            ...
            <td style="vertical-align:middle; text-align:center;"><a href="<%= string.Format("../../AG/Application/{0}", app.Id) %>">Просмотр</a></td>
         </tr>
     <% } %>
     </table>
    <% }
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align:middle; text-align:center;">
                        <a href="<%= string.Format("../../AG/Application/{0}", app.Id) %>">Просмотр</a>
                    </td>
                </tr>
            </tbody>
     <% } %>
