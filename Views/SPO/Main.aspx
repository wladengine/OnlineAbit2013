<%@ Page Title="" Language="C#" MasterPageFile="~/Views/SPO/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.SimplePerson>" %>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align:middle; text-align:center;">
                        <a href="<%= string.Format("../../Application/Index/{0}", app.Id) %>">Просмотр</a>
                    </td>
                </tr>
            </tbody>
     <% } %>
