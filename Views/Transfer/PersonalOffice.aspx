...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Abiturient/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.PersonalOfficeTransfer>" %>
...
%>
    ...
    <div class="grid">
        <div class="wrapper">
            ...
            <% } %>
            <form id="form" class="form panel" action="Transfer/NextStep" method="post" onsubmit="return CheckForm();">
            ...
            <div class="grid_2">
                    <ol>
                        <li><a href="../../Transfer?step=1"><%= GetGlobalResourceObject("PersonInfo", "Step1")%></a></li>
                        <li><a href="../../Transfer?step=2"><%= GetGlobalResourceObject("PersonInfo", "Step2")%></a></li>
                        <li><a href="../../Transfer?step=3"><%= GetGlobalResourceObject("PersonInfo", "Step3")%></a></li>
                        <li><a href="../../Transfer?step=4"><%= GetGlobalResourceObject("PersonInfo", "Step4")%></a></li>
                        <li><a href="../../Transfer?step=5"><%= GetGlobalResourceObject("PersonInfo", "Step6")%></a></li>
                    </ol>
                </div>
        </div>
    </div>
            ...
            <div class="wrapper">
                <div class="grid_4 first">
                    ...
                    <form id="form" class="form panel" action="Transfer/NextStep" method="post" onsubmit="return CheckForm();">
                        ...
                        <h4>Сведения о текущем месте обучения</h4>
                        <div class="clearfix">
...
%>
    ...
    <div class="grid">
        <div class="wrapper">
            ...
            <% } %>
                <form class="panel form" action="Transfer/NextStep" method="post">
