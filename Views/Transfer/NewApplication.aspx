...
<script type="text/javascript">
    ...
    function GetFaculties() {
        ...
        $('#Specs').hide();
        $('#Facs').show();
        $.post('/Transfer/GetFacs', { studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(), entry: $('#Entry').val() }, function (json_data) {
            var options = '';
    ...
    function GetProfessions() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/Transfer/GetProfs', { studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(),
    ...
    function GetObrazPrograms() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/Transfer/GetObrazPrograms', { prof: $('#lProfession').val(), studyform: $('#StudyFormId').val(), studybasis: $('#StudyBasisId').val(), 
    ...
    function GetSpecializations() {
        ...
        $('#Specs').hide();
        $('#FinishBtn').hide();
        $.post('/Transfer/GetSpecializations', { prof: $('#lProfession').val(), obrazprogram: $('#lObrazProgram').val(), studyform: $('#StudyFormId').val(), 
...
<% using (Html.BeginForm("NewApp", "Transfer", FormMethod.Post))
   { 
%> 
