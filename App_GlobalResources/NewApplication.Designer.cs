...
namespace Resources {
    ...
    internal class NewApplication {
        ...
        /// <summary>
        ///   Ищет локализованную строку, такую же, как Уважаемый абитуриент. В этом окне необходимо выбрать &lt;b&gt;все&lt;/b&gt; конкурсы, в которых Вы желаете участвовать.&lt;br&gt;После добавления одного конкурса, Вам будет доступно добавление следующего..
        /// </summary>
