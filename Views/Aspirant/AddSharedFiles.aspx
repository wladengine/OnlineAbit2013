<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Aspirant/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.AppendFilesModel>" %>
...
<p class="message info">
    <asp:Literal runat="server" Text="<%$ Resources:AddSharedFiles, HelpMessage_Aspirant %>"></asp:Literal>
</p>
<form action="/Aspirant/AddSharedFile" method="post" class="form panel" enctype="multipart/form-data">
    <fieldset>
        <div class="clearfix">
