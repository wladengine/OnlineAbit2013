...
<%@ Page Title="" Language="C#" MasterPageFile="~/Views/ChangeStudyForm/PersonalOffice.Master" Inherits="System.Web.Mvc.ViewPage<OnlineAbit2013.Models.PersonalOfficeChanging>" %>
...
%>
    ...
    <div class="grid">
        <div class="wrapper">
            ...
            <% } %>
            <form id="form" class="form panel" action="ChangeStudyForm/NextStep" method="post" onsubmit="return CheckForm();">
            ...
            <div class="grid_2">
                <ol>
                    <li><a href="../../ChangeStudyForm?step=1"><%= GetGlobalResourceObject("PersonInfo", "Step1")%></a></li>
                    <li><a href="../../ChangeStudyForm?step=2"><%= GetGlobalResourceObject("PersonInfo", "Step2")%></a></li>
                    <li><a href="../../ChangeStudyForm?step=3"><%= GetGlobalResourceObject("PersonInfo", "Step3")%></a></li>
                    <li><a href="../../ChangeStudyForm?step=4"><%= GetGlobalResourceObject("PersonInfo", "Step4")%></a></li>
                    <li><a href="../../ChangeStudyForm?step=5"><%= GetGlobalResourceObject("PersonInfo", "Step6")%></a></li>
                </ol>
             </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    <div class="grid">
        <div class="wrapper">
            ...
            <% } %>
                <form class="panel form" action="ChangeStudyForm/NextStep" method="post">
                    ...
                    <div class="clearfix">
                        <h4>Основание для перевода на бюджетную основу обучения:</h4>
                        <span onclick="OpenReasons()" class="link">кликните, чтобы просмотреть список оснований для перевода</span><br />
                        <!-- <textarea id="AddPerson_ExtraInfo" name="AddPerson.ExtraInfo" cols="40" rows="4" class="ui-widget-content ui-corner-all"></textarea> -->
                        <%= Html.TextAreaFor(x => x.ChangingAddInfo.Reason, 5, 70, new Dictionary<string, object>() { { "class", "noresize" } })%>
                    </div>
                    <div class="clearfix">
